...
<html>
	...
	<div class="box">
		...
		<form action="funcionario_perfil.php" method="POST" autocomplete="off">
			...
			<div class="field"><h1><strong>Funcionário</strong></h1><p><br>

				<h3>Olá, <strong>
				<?php echo $_SESSION['nome']; ?> <br> Matrícula: <?php echo $_SESSION['matricula']; ?> <br>
	...
	<div class="field">
		<div class="control">
			<h2><a class="button is-rounded is-block is-dark is-large is-fullwidth " href="funcionario_verifica_usuario.php">Lista de Clientes</a></h2>
		</div>
	</div>
