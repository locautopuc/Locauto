	...
	<!-- Esta interface terá comunicação com o arquivo login.php -->
		...
		<div class="field">
			<div class="control">
				...
				<input name="cpf_cnpj" name="text" class="input is-large" placeholder="CPF ou CNPJ" autofocus="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="14">
			</div>
		</div>
